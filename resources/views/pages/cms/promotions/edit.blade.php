        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Promotions | Edit</h3>
                </div>

                <form class="form-horizontal" action="{{ route('cms.promotions.update', $promotion->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="title"
                                    ...
                                    placeholder="Title" value="{{ old('title', $promotion->title) }}" required>
                                @error('title')
                        ...
                        <div class="row mb-2">
                            ...
                            <img class="col-sm-6 img-preview" src="{{ $promotion->image }}">
                        </div>
                        <div class="form-group row">
                            <label for="content" class="col-sm-2 col-form-label">Content</label>
                            <div class="col-sm-10">
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="content"
                                    placeholder="Content" rows="4" required>{{ old('content', $promotion->content) }}
                                </textarea>
                                @error('content')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="created_at" name="created_at"
                                    ...
                                    value="{{ old('created_at', $promotion->created_at) }}" data-target="#created_at"
                            ...
                            <div class="col-sm-6">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input @error('status') is-invalid @enderror" type="radio"
                                        id="active" name="status" value="1" @checked(old('status', $promotion->status) == '1')>
                                    <label for="active" class="custom-control-label">Active</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input @error('status') is-invalid @enderror" type="radio"
                                        id="inactive" name="status" value="0" @checked(old('status', $promotion->status) == '0')>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('cms.promotions.index') }}" class="btn btn-warning">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
