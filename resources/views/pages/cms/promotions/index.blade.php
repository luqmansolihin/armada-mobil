            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-2 p-0 mb-2">
                        <a href="{{ route('cms.promotions.create') }}" class="btn btn-primary btn-block">Add Promotion</a>
                    </div>

                    <table id="promotions" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Title</th>
                                <th>Status</th>
    ...
    <script>
        $(function() {
            $("#promotions").DataTable({
                ...
                .buttons()
                .container()
                .appendTo('#promotions_wrapper .col-md-6:eq(0)');
        });
    </script>
@endpush
