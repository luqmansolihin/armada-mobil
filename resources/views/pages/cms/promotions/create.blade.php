        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Promotions | Create</h3>
                </div>

                <form class="form-horizontal" action="{{ route('cms.promotions.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="created_at" name="created_at"
                                    ...
                                    value="{{ old('created_at') }}" data-target="#created_at" data-toggle="datetimepicker"
