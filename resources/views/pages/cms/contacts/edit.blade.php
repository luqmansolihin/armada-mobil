        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Contacts | Update</h3>
                </div>

                <form class="form-horizontal" action="{{ route('cms.contacts.update', $contact->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="type"
                                    ...
                                    id="type" placeholder="Choose Day" required>
                                    @foreach (App\Enums\ContactTypeEnum::cases() as $type)
                                        <option value="{{ $type->value }}" @selected($type->value == old('type', $contact->type))>
