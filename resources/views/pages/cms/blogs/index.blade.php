                ...
                <div class="card-body">
                    ...
                    <table id="blogs" class="table table-bordered table-striped">
                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                <td>{{ $blog->title }}</td>
                                <td>@if($blog->status) active @else inactive @endif</td>
                                <td>{{ $blog->created_at->tz('Asia/Jakarta')->format('d-m-Y H:i:s') }}</td>
                                <td>
                                    <a href="{{ route('cms.blogs.edit', $blog->id) }}" class="badge bg-warning" title="Update"><i class="fas fa-edit"></i></a>
                                    <form action="{{ route('cms.blogs.delete', $blog->id) }}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
